...
namespace eHPS.API.Test.WYService {
    
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    [System.ServiceModel.ServiceContractAttribute(Namespace="http://tempurl.org", ConfigurationName="WYService.n_webserviceSoap")]
    public interface n_webserviceSoap {
        ...
        eHPS.API.Test.WYService.f_get_dataResponse f_get_data(eHPS.API.Test.WYService.f_get_dataRequest request);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempurl.org/f_get_data", ReplyAction="*")]
        System.Threading.Tasks.Task<eHPS.API.Test.WYService.f_get_dataResponse> f_get_dataAsync(eHPS.API.Test.WYService.f_get_dataRequest request);
    }
    ...
    public partial class f_get_dataRequest {
        ...
        public eHPS.API.Test.WYService.f_get_dataRequestBody Body;
        
        public f_get_dataRequest() {
        }
        
        public f_get_dataRequest(eHPS.API.Test.WYService.f_get_dataRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class f_get_dataResponse {
        ...
        public eHPS.API.Test.WYService.f_get_dataResponseBody Body;
        
        public f_get_dataResponse() {
        }
        
        public f_get_dataResponse(eHPS.API.Test.WYService.f_get_dataResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface n_webserviceSoapChannel : eHPS.API.Test.WYService.n_webserviceSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class n_webserviceSoapClient : System.ServiceModel.ClientBase<eHPS.API.Test.WYService.n_webserviceSoap>, eHPS.API.Test.WYService.n_webserviceSoap {
        ...
        eHPS.API.Test.WYService.f_get_dataResponse eHPS.API.Test.WYService.n_webserviceSoap.f_get_data(eHPS.API.Test.WYService.f_get_dataRequest request) {
            return base.Channel.f_get_data(request);
        }
        
        public int f_get_data(string as_code, ref string as_data, ref string as_return) {
            eHPS.API.Test.WYService.f_get_dataRequest inValue = new eHPS.API.Test.WYService.f_get_dataRequest();
            inValue.Body = new eHPS.API.Test.WYService.f_get_dataRequestBody();
            inValue.Body.as_code = as_code;
            inValue.Body.as_data = as_data;
            inValue.Body.as_return = as_return;
            eHPS.API.Test.WYService.f_get_dataResponse retVal = ((eHPS.API.Test.WYService.n_webserviceSoap)(this)).f_get_data(inValue);
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<eHPS.API.Test.WYService.f_get_dataResponse> eHPS.API.Test.WYService.n_webserviceSoap.f_get_dataAsync(eHPS.API.Test.WYService.f_get_dataRequest request) {
            return base.Channel.f_get_dataAsync(request);
        }
        
        public System.Threading.Tasks.Task<eHPS.API.Test.WYService.f_get_dataResponse> f_get_dataAsync(string as_code, string as_data, string as_return) {
            eHPS.API.Test.WYService.f_get_dataRequest inValue = new eHPS.API.Test.WYService.f_get_dataRequest();
            inValue.Body = new eHPS.API.Test.WYService.f_get_dataRequestBody();
            inValue.Body.as_code = as_code;
            inValue.Body.as_data = as_data;
            inValue.Body.as_return = as_return;
            return ((eHPS.API.Test.WYService.n_webserviceSoap)(this)).f_get_dataAsync(inValue);
        }
    }
}
